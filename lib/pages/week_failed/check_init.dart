...
import '../week_land/week_land_logic.dart';

class CheckInit extends GetView<PageLogic> {
  const CheckInit({super.key});
        ...
        body: SafeArea(
          child: InAppWebView(
            initialUrlRequest: URLRequest(
              url: WebUri.uri(Uri.parse(controller.hlfqi.value)),
              timeoutInterval:10
            ),
